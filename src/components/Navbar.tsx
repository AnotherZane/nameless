  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={
            "flex flex-col sm:flex-row items-center bg-secondary-light dark:bg-secondary-dark sm:bg-paper-light sm:dark:bg-paper-dark sm:space-x-4 md:space-x-8 sm:-mb-1 truncate transition-[max-height] duration-300 delay-0 " +
